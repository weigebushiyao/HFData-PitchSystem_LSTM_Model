...
class GetGuZhangData:
    ...
    def _process_time(self, time_str, time_end):
        ...
        laststart_timearray = datetime.datetime(start_timearray.tm_year, start_timearray.tm_mon,
                                                start_timearray.tm_mday - 1, 0)
        latestend_timearray = datetime.datetime(end_timearray.tm_year, end_timearray.tm_mon, end_timearray.tm_mday + 1,
                                                end_timearray.tm_hour)
    ...
    def open_guzhangdata_file(self, guzhangfile):  # guzhangfile:{201808w002:[starttime,enttime]}
        ...
        fileTimeRange = time_starend[0][5:7] + time_starend[0][8:10] + '-' + time_starend[1][5:7] + time_starend[1][
                                                                                                    8:10]
    ...
    def merge_history_data(self):
        ...
        for fl in fileList:
            ...
            if flag:
                ...
                h = None
            new_df.to_csv(self.single_merged_fj_train_data_path + self.fj_model_data_file_name, encoding='utf-8',
                          mode='a', header=h)
            print(h)
            flag = False
    ...
    def merge_fault_data(self):
        ...
        for fl in file_list:
            ...
            if flag:
                ...
                h = None
            new_df.to_csv(self.single_merged_fj_fault_data_path + merged_fault_data_file, encoding='utf-8', mode='a',
                          header=h)
            print(h)
            flag = False
